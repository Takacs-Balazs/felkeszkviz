/*function UjKerdes() {
    ...
    let kerdesHeader = document.createElement("h1");
    let kerdesSzoveg = document.createTextNode("This is new.");
    
    kerdesHeader.appendChild(kerdesSzoveg);
    bodyContainer.appendChild(kerdesHeader);
}
UjKerdes();
*/
